...
const ChatSystem = ({ currentPage = 'home' }: ChatSystemProps) => {
  ...
  const translations = {
    ...
    hi: {
      ...
      contextualHelp: {
        home: "क्या आप चाहते हैं कि मैं आज आपको कुछ नया खोजने में मदद करूं?",
        gallery: "क्या आप रंग या विषय के आधार पर सुझाव चाहते हैं?",
        about: "मैं कलाकार के महत्वपूर्ण क्षणों के बारे में आपका मार्गदर्शन कर सकता हूं, बस पूछें!",
        contact: "मैं कलाकार को सीधे संदेश लिखने में आपकी सहायता कर सकता हूं।"
      }
    },
    gu: {
      ...
      contextualHelp: {
        home: "શું તમે ઇચ્છો છો કે હું આજે તમને કંઈક નવું શોધવામાં મદદ કરું?",
        gallery: "શું તમને રંગ અથવા થીમ પ્રમાણે ભલામણો જોઈએ છે?",
        about: "હું કલાકારના મહત્વપૂર્ણ ક્ષણો દ્વારા તમારું માર્ગદર્શન કરી શકું છું, માત્ર પૂછો!",
        contact: "હું કલાકારને સીધો સંદેશ લખવામાં તમારી મદદ કરી શકું છું."
      }
    }
  };
